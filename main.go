...
import (
	"encoding/json"
	"fmt"
	"github.com/nicholasgasior/go-broccli"
...
func main() {
	cli := broccli.NewCLI("github-actions-runners-exporter", "GitHub Actions' runners exporter for Prometheus", "devops@alephzero")
